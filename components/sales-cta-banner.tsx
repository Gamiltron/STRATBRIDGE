...
export function SalesCtaBanner() {
  return (
    <section id="contact" className="bg-cream-dark" aria-labelledby="sales-cta-heading">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-14 lg:flex-row lg:items-center lg:justify-between lg:px-10">
        <div className="max-w-2xl">
          ...
          >
            A technology-enabled revenue engine for a stronger tomorrow<span className="text-rust">.</span>
          </h2>
          <p className="mt-3 text-base text-navy/70">
            Let&apos;s discuss how we can help you build a modern sales and GTM
            function that drives measurable growth.
          </p>
        </div>
