...
export function ProcurementCtaBanner() {
  return (
    <section id="contact" className="bg-cream-dark" aria-labelledby="procurement-cta-heading">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-14 lg:flex-row lg:items-center lg:justify-between lg:px-10">
        <div className="max-w-2xl">
          ...
          >
            The right partners. A stronger tomorrow.
          </h2>
          <p className="mt-3 text-base text-navy/70">
            Let&apos;s discuss how we can help you source and contract the
