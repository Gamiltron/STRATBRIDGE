...
const areas = [
  { Icon: GearIcon, label: 'ERP implementation and modernisation' },
  { Icon: UsersIcon, label: 'CRM implementation and optimisation' },
  { Icon: SyncIcon, label: 'System integration and data migration' },
  { Icon: DocumentIcon, label: 'Process redesign and standardisation' },
  { Icon: BarChartIcon, label: 'Change management and user enablement' },
]
...
export function ErpSolutionsSection() {
  return (
    <section className="bg-cream-dark/60" aria-labelledby="erp-solutions-heading">
      <div className="mx-auto grid max-w-7xl items-stretch gap-10 px-6 py-16 lg:grid-cols-2 lg:gap-12 lg:px-10 lg:py-20">
        <div>
          ...
          <h2
            id="erp-solutions-heading"
            className="mt-4 font-serif text-3xl font-semibold text-navy sm:text-4xl"
          >
            From implementation to real business outcomes<span className="text-rust">.</span>
          </h2>
        ...
        <div className="flex flex-col bg-navy-dark p-10 text-cream">
          ...
          <p className="mt-auto text-xs font-medium uppercase leading-relaxed tracking-[0.2em] text-cream/80">
            CONNECTED SYSTEMS. REAL BUSINESS PROGRESS.
          </p>
        </div>
      </div>
    </section>
