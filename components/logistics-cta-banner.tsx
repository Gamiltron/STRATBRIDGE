...
export function LogisticsCtaBanner() {
  return (
    <section id="contact" className="bg-cream-dark" aria-labelledby="logistics-cta-heading">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-14 lg:flex-row lg:items-center lg:justify-between lg:px-10">
        <div className="max-w-2xl">
          ...
          <h2
            id="logistics-cta-heading"
            className="mt-4 font-serif text-3xl font-semibold leading-tight text-navy sm:text-4xl"
          >
            A more efficient, resilient logistics function<span className="text-rust">.</span>
          </h2>
          <p className="mt-3 text-base text-navy/70">
            Let&apos;s discuss how we can help you transform your logistics
            operations.
          </p>
        </div>
